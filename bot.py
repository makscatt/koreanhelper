...
- Необычные истории из мира науки (чувак вылечил собаку от рака, энтузиаст собрал что-то безумное)
- Технологические прорывы (новые чипы, AI-достижения, роботы, энергетика)
- Космос: запуски, открытия, миссии
- Крупные медицинские новости (вакцины, методы лечения, эпидемии)
- DIY-проекты и хакерские штуки с технологиями
- Экология и климат — только если есть конкретный инфоповод

ЧТО МУСОР (1-6 баллов, ВЫКИДЫВАЙ):
- Рутинные публикации без прорыва («учёные изучили» без результата)
- Переписывание пресс-релизов компаний без новизны
- Общие рассуждения о будущем технологий без конкретики
- Мелкие обновления софта и гаджетов
...
БОНУС: истории типа «энтузиаст собрал пейджер из Telegram и Raspberry Pi» или «чувак разработал лекарство от рака для своей собаки» — это 9-10 баллов. Необычные, конкретные, с характером.
""",
...
POST_PROMPT = """
Ты — автор Telegram-канала с характером. Пишешь живо, конкретно, с лёгким юмором и авторской подачей.
...
СТИЛЬ И ТОН:
- Живой разговорный язык. Не пресс-релиз, не новостная лента, а рассказ от человека, который в теме.
- Можно и нужно: «чувак», «жёстко», «мощный», «безумные», «в ярости» — если к месту.
- Юмор и авторские комментарии приветствуются, но не натужные.
- Последняя строка может быть ироничным/остроумным послесловием (1-5 слов) — но ТОЛЬКО если придумалось что-то реально хорошее. Не натягивай.

ФОРМАТ:
1 строка: один эмодзи + цепляющий заголовок (до 60 символов). Заголовок должен передавать СУТЬ, а не интриговать.
2-5 строк: раскрытие новости. Конкретика: имена, цифры, даты, детали. Каждое предложение должно нести новую информацию.
...
Спустя 23 года после съёмок актёр, сыгравший Фродо, наконец-то добрался до первоисточника — признался на The Late Show. Книги назвал «восхитительными». Возможно, готовится к возвращению в «Охоте на Голлума».

🕷 Трейлер «Человека-паука» побил мировой рекорд
Ролик Spider-Man: Brand New Day собрал 718,6 млн просмотров за первые 24 часа — почти вдвое больше «Дэдпула и Росомахи» (365 млн).

🦠 Новый фильм от создателя «Поезда в Пусан»
Ён Сан-хо снимает «Колонию» — вирус блокирует людей в здании, заражённые мутируют. В касте Чон Джи-хён и Ку Гё-хван.

💿 «Мармеладная» пластинка по «Паддингтону»
На виниле — саундтрек лондонского мюзикла. Внутри пластинки оранжевая жидкость, как любимый мармелад Паддингтона. Выпускает Blood Records — они специализируются на таких лимитках.
