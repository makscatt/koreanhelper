...
def analyze():
    ...
    2. ОБЯЗАТЕЛЬНО подставляй слово из предложения в начальной форме (инфинитиве).
       ...
       - ХОРОШО: "왜 (Наречие)"
    3. Объясняй просто и кратко, используя теги <b>жирный</b> и <br>.
    4. Указывай нюансы (вежливость, панмаль).
    ...
    {{
      ...
      "grammar": [
        {{ 
          ...
          "explanation": "Объяснение, как это работает здесь.", 
          "example": "Короткий пример" 
        }}
      ]
    }}
    """
