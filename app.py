...
def analyze():
    ...
    4. Добавляй разбор по словам в формате: "Слово - перевод".
    5. Добавляй разбор по грамматикам в формате: "Грамматика - конкретное значение". Например: "네(요) - удивление, осознание или согласие"
    ...
    {{
      ...
      "grammar": [
        {{ 
          ...
          "example": "3 коротких примера с переводом" 
        }}
      ]
    }}
    """
